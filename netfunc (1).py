...
import ufunc
from ufunc import picking_arch, process_image
...
def save_checkpoint (model, train_set, epochs, optimizer, architecture, checkpoint_dir):
    checkpoint = {'structure': picking_arch(architecture),'classifier': model.classifier, 'state_dict': model.state_dict(),
