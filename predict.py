...
#image data argument
aparser.add_argument('image_path' , default = 'home/workspace/ImageClassifier/flowers/test/20/image_04910', action = 'store_true')
...
# Getting prediction
probs, classes = netfunc.predict(image_path, loaded_model, top_k)
print(probs, classes)
